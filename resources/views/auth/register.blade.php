	    ...
	    <form name="loginForm" id="loginForm" novalidate="" method="post">
	    	...
	    	<div class="row control-group">
	            <div class="form-group col-xs-12 floating-label-form-group controls">
	                <label>Name</label>
	                <input type="text" class="form-control" placeholder="Name" name="name" id="phone" required="" data-validation-required-message="Please enter your name." value="{{old('name')}}">
			...
			<div class="row control-group">
	            <div class="form-group col-xs-12 floating-label-form-group controls">
	                ...
	                <input type="password" class="form-control" placeholder="Password Confirmation" name="password_confirmation" id="phone" required="" data-validation-required-message="Please enter your password confirmation.">
	                <p class="help-block text-danger"></p>
	            </div>
	        </div>
